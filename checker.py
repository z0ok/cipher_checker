...
def args():
    try:
        ...
        if parser.scope_file and parser.scope_ip:
            ...
            exit()
        if parser.verbose:
            scan_obj.verbose = True
        if parser.target_port:
            scan_obj.port = parser.target_port
